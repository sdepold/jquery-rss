...
""),d=0;d<c.htmlTags.length;d++)a=a.replace(RegExp("<"+c.htmlTags[d],"gi"),"");return a}(a),shortBodyPlain:a.contentSnippet.replace(/<\/?[^>]+>/gi,""),index:jQuery.inArray(a,this.entries),totalEntries:this.entries.length,teaserImage:function(a){try{return a.content.match(/(<img.*?>)/gi)[0]}catch(d){return""}}(a),teaserImageUrl:function(a){try{return a.content.match(/(<img.*?>)/gi)[0].match(/src="(.*?)"/)[1]}catch(d){return""}}(a)},this.options.tokens)};c.prototype.getValueForToken=function(a,b){var d=
this.getTokenMap(b),c=a.replace(/[\{\}]/g,""),c=d[c];if("undefined"!=typeof c)return"function"==typeof c?c(b,d):c;throw Error("Unknown token: "+a);};e.fn.rss=function(a,b,d){(new c(this,a,b,d)).render()}})(jQuery);
