...
b.length?!1:this.options.filter(a,c):!0};e.prototype.getTokenMap=function(a){if(!this.feedTokens){var b=JSON.parse(JSON.stringify(this.feed));delete b.entries;this.feedTokens=b}this.formattedDate=this.options.dateFormatFunction?this.options.dateFormatFunction(a.publishedDate):"undefined"!==typeof moment?moment(new Date(a.publishedDate)).format(this.options.dateFormat):a.publishedDate;return d.extend({feed:this.feedTokens,url:a.link,author:a.author,date:this.formattedDate,title:a.title,body:a.content,
